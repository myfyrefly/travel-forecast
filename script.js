...
$("#searchWeather").click(function() {
  ...
  var fiveDayQueryURL =
    ...
    //my API key isn't working for some reason, Dustin let me borrow his
//https://api.openweathermap.org/data/2.5/forecast/daily?appid=035957dcae9879b8e7c72469f4811705&q=San%20Antonio&cnt=5
  $.ajax({
    url: cityQueryURL,
    method: "GET"
  }).then(function(data) {
